...
def main() -> None:
    ...
    print(f"\n🚀 IGNITION: Starting Zephyr Gym from Run {START_RUN} of {total_runs} (OFFLINE/LOCAL ONLY)...\n")
    ...
    for idx, scenario in enumerate(active_curriculum, start=START_RUN):
        ...
        # ==========================================
        # 🛑 VRAM SAVER: JIT INGESTION DISABLED 🛑
        # ==========================================
        ...
        if current_timestamp - last_backup_timestamp > BACKUP_INTERVAL_SECONDS:
            # ==========================================
            # 🛑 CLOUD SAVER: INTERMEDIARY SUPABASE BACKUP DISABLED 🛑
            # ==========================================
    ...
    # ==========================================
    # 🛑 CLOUD SAVER: FINAL SUPABASE BACKUP DISABLED 🛑
    # ==========================================
